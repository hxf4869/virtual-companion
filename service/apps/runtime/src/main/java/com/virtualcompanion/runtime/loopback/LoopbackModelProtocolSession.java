...
/**
 * Single-consumer deterministic session replaying the loopback event list,
 * structurally aligned with {@code FakeModelProtocolSession} (package-private
 * so callers interact only through the supplier-neutral session port).
 */
final class LoopbackModelProtocolSession implements ModelProtocolSession {
    ...
    LoopbackModelProtocolSession(List<ModelProtocolEvent> events) {
