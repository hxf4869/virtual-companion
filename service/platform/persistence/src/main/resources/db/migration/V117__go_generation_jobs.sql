...
-- Java create_attempt_intent / record_attempt_outcome / finalize_generation /
...
--    Java-era snapshot FKs become optional so Go can omit dual auth snapshots.
-- ---------------------------------------------------------------------------
...
-- Java rows but Go never acquires it.
...
-- Grants: Java functions unchanged. Go functions for runtime roles only.
