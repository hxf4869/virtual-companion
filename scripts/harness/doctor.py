...
TASK_0189_MAINTENANCE_RECORD_ID = ("OWNER-MAINT-20260813-TASK-0189-POST-TERMINAL-TAIL-01")
TASK_0189_TASK_ID = "TASK-0189"
TASK_0189_CARD_PATH = "docs/tasks/TASK-0189-canonical-greenline-restore.md"
TASK_0189_CONTEXT_PATH = "docs/tasks/context/TASK-0189.context-lock.yaml"
TASK_0189_MAINTENANCE_AUTHORIZATION_PATH = "docs/evidence/TASK-0189/pre-ready-maintenance-authorization.json"
TASK_0189_TERMINAL_COMMIT = "7f9f9e3be0dd9285e80a78707445d2ea7f7153ff"
TASK_0189_TERMINAL_TREE = "a0b261b5b85f022c98e536e2f45da007a5b8e10d"
TASK_0189_TAIL_COMMIT = "c6260059f09cd69595a70aee7ef39de45e99ca78"
TASK_0189_TAIL_TREE = "886378903a5e141c26427b2fd3666a015cfc1abe"
TASK_0189_TAIL_CHANGED_PATHS = (
    "docs/evidence/TASK-0187/evidence-pack.json",
    "docs/handoffs/TASK-0187.json",
)
TASK_0189_HEADCOMMIT_PLACEHOLDER = "0000000000000000000000000000000000000000"
# headCommit backfill identities: blob OID at the terminal commit (placeholder)
# and at the tail commit (real headCommit), plus the tail blob content sha256.
TASK_0189_TAIL_FILES = {
    "docs/evidence/TASK-0187/evidence-pack.json": {
        "terminalBlob": "4d253954df8c83d7abc08061efe1005a49c1cf3b",
        "tailBlob": "93ee33e3e30272842aa907066a5140c741770636",
        "tailSha256": "4b239c672f6c212bd406c199863d790ba59d4bc1e69e9aef746e25794f477041",
    },
    "docs/handoffs/TASK-0187.json": {
        "terminalBlob": "4f2357a79ef33538eae7cee25fa1cf57504e114e",
        "tailBlob": "878951e2fee0ae7964caf20556a88bb98e790795",
        "tailSha256": "18357061bb33f9a4a85f1867ff6e37357980ede28a9b60e6db949550815331e9",
    },
}
TASK_0189_DRAFT_COMMIT = "3b5e5566be094f0780d13a7a81dafa1b9faf790c"
TASK_0189_DRAFT_TREE = "93ff10d2de6351aceba4c054e83bee90d74e33c6"
TASK_0189_DRAFT_FILES = {
    TASK_0189_CARD_PATH: {
        "blobOid": "7971887d6b7c0665e753764a238cb0da9b586686",
        "sha256": "8e5a67735c3313faefe57521ac4982bb2204511cc62dbffc0863c6c0a81024cf",
    },
    TASK_0189_CONTEXT_PATH: {
        "blobOid": "bdfb97957a1a82d8e52e3e5eb1773c0c507da111",
        "sha256": "136cf15195f315daa514d044ea1467eabe8e9f76581218725839146cfbee3b84",
    },
}
TASK_0189_PRE_READY_MAINTENANCE_PATHS = {
    ".harness/ci-execution-policy.yaml",
...
TASK_0196_PRE_READY_RECORD_ID = "OWNER-MAINT-20260814-TASK-0196-PRE-READY-01"
TASK_0196_POST_TERMINAL_TAIL_RECORD_ID = (
    "OWNER-MAINT-20260814-TASK-0196-POST-TERMINAL-TAIL-01"
)
TASK_0196_TASK_ID = "TASK-0196"
TASK_0196_CARD_PATH = "docs/tasks/TASK-0196-post-terminal-tail-doctor-fix.md"
TASK_0196_CONTEXT_PATH = "docs/tasks/context/TASK-0196.context-lock.yaml"
TASK_0196_MAINTENANCE_AUTHORIZATION_PATH = (
    "docs/evidence/TASK-0196/pre-ready-maintenance-authorization.json"
)
TASK_0196_TERMINAL_COMMIT = "fe0253fc9cfd0b3d88c11a18273c25b2a8e9274f"
TASK_0196_TERMINAL_TREE = "e1356cd6b521ae68d6b21f7e7f8e0b8f49dc4b71"
TASK_0196_TERMINAL_TASK_ID = "TASK-0195"
TASK_0196_TERMINAL_STATE = "ACCEPTED"
TASK_0196_TAIL_COMMIT = "751cb9db547df2ba33d55d310276bc14e1fbd5eb"
TASK_0196_TAIL_TREE = "adfe981041de9027b9d5b2b83697dd2500fe3c3f"
TASK_0196_TAIL_CHANGED_PATHS = ("docs/handoffs/TASK-0195.json",)
# Three-state legacy healing verification constants. At the canonical terminal
# commit fe0253f the handoff nextAction and the project-state nextAction are
# byte-for-byte DIFFERENT (original mismatch); the only change of the tail
# commit 751cb9d is that one wording line; at 751cb9d both nextAction values
# are byte-for-byte identical. The terminal commit is never restated as
# originally consistent.
TASK_0196_TERMINAL_HANDOFF_NEXT_ACTION = (
    "TASK-0195 ACCEPTED 终态提交后保持不推送不合并；后续规划（bounded "
    "retry/dead-letter 串行卡等）由 Owner 在推送/合并决策与 Backlog 晋级时"
    "另行指示，当前无新活动任务。"
)
TASK_0196_TERMINAL_STATE_NEXT_ACTION = (
    "TASK-0195 ACCEPTED 终态（继承实现正式接纳完成）后保持不推送不合并；"
    "后续规划（bounded retry/dead-letter 串行卡等）由 Owner 在推送/合并决策"
    "与 Backlog 晋级时另行指示，当前无新活动任务。"
)
TASK_0196_TAIL_FILES = {
    "docs/handoffs/TASK-0195.json": {
        "terminalBlob": "af6f12600a30648a7a46e7715b1c0e998146b856",
        "terminalSha256": (
            "573fe84594087ac869a2cca7a9406d67a41753c43984511a71a88d080ef6e898"
        ),
        "tailBlob": "d00ec0dfd535ce0480444db45a0d8cff7c06e5fd",
        "tailSha256": (
            "ea23f12deb5d724de90b10f91d04a759ba19b92b2d3616640c1e98ddbb2c6749"
        ),
    },
}
TASK_0196_DRAFT_COMMIT = "ea129d1b9ffbfee98a8a67aefccce1b1bf854254"
TASK_0196_DRAFT_TREE = "01f09d44f6d93aa84200cc526b9bc3ef2be1a0d5"
TASK_0196_DRAFT_FILES = {
    TASK_0196_CARD_PATH: {
        "blobOid": "63de5894953924918e54b1a8874d9449fcadb803",
        "sha256": (
            "9860522e6964b8e50c91c798cf69f802953e1658da780e7a366fa8d00e55b314"
        ),
    },
    TASK_0196_CONTEXT_PATH: {
        "blobOid": "98b80c4879738822c9ae4cf2d1f6683ac40bceb8",
        "sha256": (
            "94f7cdac9d3fe30c474e0815f3d62883b260a001cd9ad06cdcc645efdaa077f4"
        ),
    },
}
TASK_0196_PRE_READY_MAINTENANCE_PATHS = {
    ".harness/ci-execution-policy.yaml",
    "docs/evidence/TASK-0196/pre-ready-maintenance-authorization.json",
    "scripts/harness/doctor.py",
    "scripts/harness/tests/test_harness.py",
...
TASK_0196_EXACT_OWNER_AUTHORIZATION = (
    "Owner 2026-08-14 批准 TASK-0196 的一次性 pre-READY maintenance 边界（recordId "
    "OWNER-MAINT-20260814-TASK-0196-PRE-READY-01）：maintenance 边必须是修订后最终 "
    "DRAFT 提交（ea129d1）的直接单父提交；恰好只能修改 6 个冻结路径，不得增删；"
    "oneTimeOnly；绑定 DRAFT commit/tree、直接父、精确路径集合及各路径 "
    "mode/blob/content hash；消费后不可复用，但历史验证证明必须继续保留；禁止环境变量、"
    "CLI flag、git notes/replace/graft、通配 allowlist、分支/worktree 差异或通用 "
    "override；不得修改 TASK-0098/0189/0191–0195 的任何历史制品；不得改写 fe0253f 或 "
    "751cb9d。同时批准一次性 tail 接纳记录 "
    "OWNER-MAINT-20260814-TASK-0196-POST-TERMINAL-TAIL-01（fe0253f→751cb9d 唯一历史"
    "例外，legacy healing 三态验证：fe0253f 原始 nextAction 不一致——handoff 缺（继承"
    "实现正式接纳完成）措辞；751cb9d 唯一改动 docs/handoffs/TASK-0195.json 的 nextAction "
    "一行措辞；751cb9d 后 handoff 与 project-state nextAction 逐字一致；不得把 fe0253f "
    "追述为原本一致）。"
)
TASK_0196_CI_POLICY_PROJECTION_HASH = (
    "29fd47054263c1bd61af6fe0b5cfc3a466dcc01ff1d3459d5f02722f60420e64"
)
# TASK-0196 append-only recovery edge (Owner 2026-08-14 plan D): 8114da2 is the
# consumed-but-failed pre-READY maintenance attempt (targeted tests PASS,
# Doctor FAIL 1169 errors, no READY authorization, never reusable as any
# maintenance authorization). RECOVERY-02 is the second one-time edge: the
# direct single-parent child of 8114da2 changing exactly 7 frozen paths. The
# original pre-ready-maintenance-authorization.json and the original policy
# record keep their historical meaning (first record stays auditable but
# inert). No generalized "maintenance after maintenance" capability exists.
TASK_0196_RECOVERY_RECORD_ID = "OWNER-MAINT-20260814-TASK-0196-PRE-READY-RECOVERY-02"
TASK_0196_RECOVERY_AUTHORIZATION_PATH = (
    "docs/evidence/TASK-0196/pre-ready-maintenance-recovery-authorization.json"
)
TASK_0196_FAILED_ATTEMPT_COMMIT = "8114da22959af5f7e2dcb966da8bce6d83a14d3c"
TASK_0196_FAILED_ATTEMPT_TREE = "623262a623308fdfd088cd807f04de7b411638de"
TASK_0196_ORIGINAL_DRAFT_COMMIT = "ea129d1b9ffbfee98a8a67aefccce1b1bf854254"
TASK_0196_ORIGINAL_DRAFT_TREE = "01f09d44f6d93aa84200cc526b9bc3ef2be1a0d5"
TASK_0196_RECOVERY_PATHS = {
    ".harness/ci-execution-policy.yaml",
    "docs/evidence/TASK-0196/pre-ready-maintenance-recovery-authorization.json",
...
def validate_ready_project_state_checkpoint(
    ...
    elif task_id == TASK_0189_TASK_ID:
        audit.require(
            parent_commit != authorization_commit
            and task0189_post_terminal_tail_boundary_candidate(parent_commit),
            "TASK-0189 post-terminal tail acceptance: READY parent must be the "
            "exact single-parent maintenance boundary",
        )
        validate_task0189_post_terminal_tail_boundary(audit, parent_commit)
...
def validate_task0189_post_terminal_tail_record(
    audit: Audit,
    policy: dict[str, Any],
) -> dict[str, Any] | None:
    """TASK-0189 one-time post-terminal tail acceptance record.

    Machine-binds the pushed post-terminal edge 7f9f9e3 -> c626005 (TASK-0187
    canonical terminal -> evidence/handoff headCommit backfill metadata tail
    changing only docs/evidence/TASK-0187/evidence-pack.json and
    docs/handoffs/TASK-0187.json, each replacing the headCommit placeholder
    0000... with the real terminal SHA) as the TASK-0189 DRAFT anchor so the
    DRAFT can legitimately use baseCommit = c626005. The tail headCommit of
    each file must equal the terminal commit byte-for-byte.
    """
    record = policy.get("task0189PostTerminalTail")
    label = "TASK-0189 post-terminal tail acceptance"
    audit.require(
        isinstance(record, dict),
        f"{label}: machine record is missing or not an object",
    )
    ...
    audit.require(
        record.get("schemaVersion") == 1
        and record.get("recordId") == TASK_0189_MAINTENANCE_RECORD_ID
        and record.get("decisionId")
        == "TASK-0189-POST-TERMINAL-TAIL-ACCEPTANCE-20260813"
        and record.get("kind")
        == "OWNER_AUTHORIZED_EXACT_ONE_TIME_POST_TERMINAL_TAIL_ACCEPTANCE"
        and record.get("targetTask") == TASK_0189_TASK_ID
        and record.get("sourceThreadId") == "zcode-audit-20260813",
        f"{label}: record identity drifted",
    )
    audit.require(
        record.get("terminal")
        == {
            "commit": TASK_0189_TERMINAL_COMMIT,
            "tree": TASK_0189_TERMINAL_TREE,
            "taskId": "TASK-0187",
            "state": "ACCEPTED",
        },
    ...
    audit.require(
        isinstance(authorization, dict)
        and set(authorization) == {"path", "sha256"}
        and authorization.get("path") == TASK_0189_MAINTENANCE_AUTHORIZATION_PATH
        and bool(
            re.fullmatch(
                r"[0-9a-f]{64}",
                str(authorization.get("sha256", "")),
    ...
    audit.require(
        ...
        and set(tail)
        == {"commit", "tree", "parent", "changedPaths", "headCommitBackfill", "files"}
        and tail.get("commit") == TASK_0189_TAIL_COMMIT
        and tail.get("tree") == TASK_0189_TAIL_TREE
        and tail.get("parent") == TASK_0189_TERMINAL_COMMIT
        and tail.get("changedPaths") == list(TASK_0189_TAIL_CHANGED_PATHS),
        f"{label}: tail binding drifted",
    )
    backfill = tail.get("headCommitBackfill")
    tail_files = tail.get("files")
    audit.require(
        isinstance(backfill, dict)
        and set(backfill) == {"placeholder", "actual"}
        and backfill.get("placeholder") == TASK_0189_HEADCOMMIT_PLACEHOLDER
        and backfill.get("actual") == TASK_0189_TERMINAL_COMMIT,
        f"{label}: headCommit backfill binding drifted",
    )
    audit.require(
        isinstance(tail_files, dict)
        and set(tail_files) == set(TASK_0189_TAIL_CHANGED_PATHS),
        f"{label}: tail file set drifted",
    )
    for path, identity in tail_files.items():
        expected = TASK_0189_TAIL_FILES[path]
        audit.require(
            isinstance(identity, dict)
            and set(identity) == {"tailBlob", "tailSha256"}
            and identity.get("tailBlob") == expected["tailBlob"]
            and identity.get("tailSha256") == expected["tailSha256"],
            f"{label}: tail file identity drifted: {path}",
        )
    draft = record.get("draft")
    audit.require(
        isinstance(draft, dict)
        and set(draft) == {"commit", "tree", "parent", "changedFiles"}
        and draft.get("commit") == TASK_0189_DRAFT_COMMIT
        and draft.get("tree") == TASK_0189_DRAFT_TREE
        and draft.get("parent") == TASK_0189_TAIL_COMMIT
        and isinstance(draft.get("changedFiles"), dict)
        and set(draft.get("changedFiles", {}))
        == {TASK_0189_CARD_PATH, TASK_0189_CONTEXT_PATH},
        f"{label}: DRAFT binding drifted",
    )
    for path, identity in (draft.get("changedFiles") or {}).items():
        expected = TASK_0189_DRAFT_FILES[path]
        audit.require(
            isinstance(identity, dict)
            and set(identity) == {"mode", "type", "blobOid", "sha256"}
            and identity.get("mode") == "100644"
            and identity.get("type") == "blob"
            and identity.get("blobOid") == expected["blobOid"]
            and identity.get("sha256") == expected["sha256"],
            f"{label}: DRAFT file identity drifted: {path}",
        )
    boundary = record.get("boundary")
    audit.require(
        isinstance(boundary, dict)
        ...
        and boundary.get("directParentCommit") == TASK_0189_DRAFT_COMMIT
        and boundary.get("directParentTree") == TASK_0189_DRAFT_TREE
        and boundary.get("singleParentRequired") is True
        and boundary.get("identityBinding")
        == "COMMIT_AND_TREE_DERIVED_FROM_EXACT_SINGLE_PARENT_CONTENT"
        and boundary.get("requiredMode") == "100644"
        and boundary.get("requiredType") == "blob"
        and boundary.get("policyContentBinding")
        == "CANONICAL_JSON_REDACT_TASK0189_BOUNDARY_DOCTOR_IDENTITY"
        and boundary.get("changedPaths")
        == sorted(TASK_0189_PRE_READY_MAINTENANCE_PATHS),
        f"{label}: boundary contract drifted",
    )
    audit.require(
        record.get("activation")
    ...
    audit.require(
        record.get("consumption")
        == {
            "consumedByTask": TASK_0189_TASK_ID,
            "consumedWhen": "READY_AUTHORIZATION_COMMITTED",
            "inertAfterConsumption": True,
            "reusableByOtherTask": False,
        },
    ...
    audit.require(
        not any(
            key != "task0189PostTerminalTail" and value == record
            for key, value in policy.items()
        ),
        f"{label}: copied machine record is forbidden",
    )
    # Live tail edge facts: c626005 must be the direct single-parent child of
    # the terminal commit 7f9f9e3, changing exactly the two evidence/handoff
    # files, and each file must backfill headCommit from the placeholder to
    # the terminal commit.
    graph = git_text(
        "rev-list",
        "--parents",
        "-n",
        "1",
        TASK_0189_TAIL_COMMIT,
    ).stdout.split()
    audit.require(
        graph == [TASK_0189_TAIL_COMMIT, TASK_0189_TERMINAL_COMMIT],
        f"{label}: tail must be a direct single-parent child of the terminal commit",
    )
    audit.require(
        changed_paths_between(
            TASK_0189_TERMINAL_COMMIT,
            TASK_0189_TAIL_COMMIT,
        )
        == list(TASK_0189_TAIL_CHANGED_PATHS),
    ...
    audit.require(
        tail_tree == TASK_0189_TAIL_TREE,
        f"{label}: tail tree drifted",
    )
    for path, identity in TASK_0189_TAIL_FILES.items():
        try:
            terminal_head = str(
                json.loads(
                    git_object(TASK_0189_TERMINAL_COMMIT, path).decode("utf-8")
                ).get("headCommit", "")
            )
            tail_head = str(
                json.loads(
                    git_object(TASK_0189_TAIL_COMMIT, path).decode("utf-8")
                ).get("headCommit", "")
            )
        except (HarnessError, json.JSONDecodeError, UnicodeError) as exc:
            audit.error(f"{label}: cannot read {path} headCommit: {exc}")
            terminal_head = ""
            tail_head = ""
        audit.require(
            terminal_head == TASK_0189_HEADCOMMIT_PLACEHOLDER
            and tail_head == TASK_0189_TERMINAL_COMMIT,
            f"{label}: headCommit backfill drifted: {path}",
        )
        entry = git_tree_entry(TASK_0189_TAIL_COMMIT, path)
        audit.require(
            entry is not None
            and entry[:2] == ("100644", "blob")
            and entry[2] == identity["tailBlob"]
            and hashlib.sha256(
                git_object(TASK_0189_TAIL_COMMIT, path)
            ).hexdigest()
            == identity["tailSha256"],
            f"{label}: tail file blob/content drifted: {path}",
        )
    return record


def task0189_post_terminal_tail_boundary_candidate(commit: str) -> bool:
    if not commit or not re.fullmatch(r"[0-9a-f]{40}", commit):
        return False
    ...
    if parent_result.returncode != 0:
        return False
    parts = parent_result.stdout.split()
    return len(parts) == 2 and parts[0] == commit and parts[1] == TASK_0189_DRAFT_COMMIT


def validate_task0189_post_terminal_tail_boundary(
    audit: Audit,
    parent_commit: str,
) -> None:
    label = "TASK-0189 post-terminal tail acceptance"
    ...
    boundary_commit = parent_commit
    audit.require(
        task0189_post_terminal_tail_boundary_candidate(boundary_commit),
        f"{label}: boundary must be the direct single-parent child of the frozen DRAFT",
    )
    if not task0189_post_terminal_tail_boundary_candidate(boundary_commit):
        return
    tail_tree = git_text(
        "show",
        "-s",
    ...
    audit.require(
        draft_graph == [TASK_0189_DRAFT_COMMIT, TASK_0189_TAIL_COMMIT]
        and draft_tree == TASK_0189_DRAFT_TREE,
        f"{label}: DRAFT binding drifted",
    )
    ancestry = git_text(
        "rev-list",
        "--reverse",
        "--ancestry-path",
        f"{TASK_0189_TAIL_COMMIT}..{boundary_commit}",
    ).stdout.splitlines()
    audit.require(
        ancestry == [TASK_0189_DRAFT_COMMIT, boundary_commit],
        f"{label}: pre-READY ancestry contains an intervening commit",
    )
    draft_diff = subprocess.run(
        ["git", "diff", "--name-only", "--no-renames", "-z", TASK_0189_TAIL_COMMIT, TASK_0189_DRAFT_COMMIT],
        capture_output=True,
    )
    actual_draft_paths = {p.decode("utf-8") for p in draft_diff.stdout.split(b"\0") if p}
    audit.require(
        actual_draft_paths == {TASK_0189_CARD_PATH, TASK_0189_CONTEXT_PATH},
        f"{label}: DRAFT path set drifted",
    )
    boundary_diff = subprocess.run(
        ["git", "diff", "--name-only", "--no-renames", "-z", TASK_0189_DRAFT_COMMIT, boundary_commit],
        capture_output=True,
    )
    actual_paths = {p.decode("utf-8") for p in boundary_diff.stdout.split(b"\0") if p}
    audit.require(
        actual_paths == TASK_0189_PRE_READY_MAINTENANCE_PATHS,
        f"{label}: boundary paths must be exact",
    )
    audit.require(
        not (actual_paths - TASK_0189_PRE_READY_MAINTENANCE_PATHS),
        f"{label}: boundary contains extra path",
    )
    audit.require(
        not (TASK_0189_PRE_READY_MAINTENANCE_PATHS - actual_paths),
        f"{label}: boundary is missing a required path",
    )
    for path in sorted(TASK_0189_PRE_READY_MAINTENANCE_PATHS):
        entry = git_tree_entry(boundary_commit, path)
        audit.require(
            entry is not None
            and entry[:2]
    ...
    try:
        ...
        return
    record = validate_task0189_post_terminal_tail_record(audit, policy)
    if record is None:
        return
    boundary = record.get("boundary")
    ...
    audit.require(
        set(exact_files)
        == set(TASK_0189_PRE_READY_MAINTENANCE_PATHS)
    ...
    audit.require(
        ...
        == TASK_0189_CI_POLICY_PROJECTION_HASH,
    ...
    audit.require(
        authorization_path == TASK_0189_MAINTENANCE_AUTHORIZATION_PATH
        and hashlib.sha256(
...
def validate_task0189_card_maintenance_contract(audit: Audit) -> None:
    label = "TASK-0189 post-terminal tail card"
    try:
        task = task_metadata_from_text(
            read_repository_text(ROOT / TASK_0189_CARD_PATH),
            TASK_0189_CARD_PATH,
        )
    except (HarnessError, OSError, UnicodeError, yaml.YAMLError) as exc:
        ...
        return
    audit.require(
        task.get("taskId") == TASK_0189_TASK_ID
        and task.get("baseCommit") == TASK_0189_TAIL_COMMIT
        and task.get("contextLock") == TASK_0189_CONTEXT_PATH
    ...
    audit.require(
        maintenance.get("recordId") == TASK_0189_MAINTENANCE_RECORD_ID
        and maintenance.get("recordPath") == TASK_0189_MAINTENANCE_AUTHORIZATION_PATH
        ...
        == len(TASK_0189_PRE_READY_MAINTENANCE_PATHS),
    ...
    audit.require(
        ...
        and harness_approval.get("approvedAt") == "2026-08-13"
        and harness_approval.get("evidence") == TASK_0189_EXACT_OWNER_AUTHORIZATION,
        f"{label}: exact Owner authorization drifted",
    )


def validate_task0196_post_terminal_tail_record(
    audit: Audit,
    policy: dict[str, Any],
) -> dict[str, Any] | None:
    """TASK-0196 one-time post-terminal tail acceptance record.

    Machine-binds the unregistered post-terminal edge fe0253f -> 751cb9d
    (TASK-0195 canonical terminal -> handoff nextAction wording alignment
    tail changing only docs/handoffs/TASK-0195.json) as the TASK-0196 DRAFT
    anchor so the DRAFT can legitimately use baseCommit = 751cb9d. This is
    the unique historical exception and never becomes a general "fix the
    mismatch with a tail afterwards" process. Legacy healing requires the
    three-state verification: (a) at fe0253f the handoff nextAction and the
    project-state nextAction are byte-for-byte DIFFERENT (original mismatch,
    never restated as originally consistent); (b) the only change of 751cb9d
    is that one nextAction wording line of docs/handoffs/TASK-0195.json;
    (c) at 751cb9d the handoff nextAction and the project-state nextAction
    are byte-for-byte IDENTICAL.
    """
    record = policy.get("task0196PostTerminalTail")
    label = "TASK-0196 post-terminal tail acceptance"
    audit.require(
        isinstance(record, dict),
        f"{label}: machine record is missing or not an object",
    )
    ...
    audit.require(
        record.get("schemaVersion") == 1
        and record.get("recordId") == TASK_0196_POST_TERMINAL_TAIL_RECORD_ID
        and record.get("decisionId")
        == "TASK-0196-POST-TERMINAL-TAIL-ACCEPTANCE-20260814"
        and record.get("kind")
        == "OWNER_AUTHORIZED_EXACT_ONE_TIME_POST_TERMINAL_TAIL_ACCEPTANCE"
    ...
    audit.require(
        record.get("terminal")
        == {
            "commit": TASK_0196_TERMINAL_COMMIT,
            "tree": TASK_0196_TERMINAL_TREE,
            "taskId": TASK_0196_TERMINAL_TASK_ID,
            "state": TASK_0196_TERMINAL_STATE,
        },
        f"{label}: terminal binding drifted",
    )
    authorization = record.get("authorization")
    audit.require(
        isinstance(authorization, dict)
        and set(authorization) == {"path", "sha256"}
        and authorization.get("path") == TASK_0196_MAINTENANCE_AUTHORIZATION_PATH
        and bool(
            re.fullmatch(
                r"[0-9a-f]{64}",
                str(authorization.get("sha256", "")),
    ...
    audit.require(
        ...
        and tail.get("commit") == TASK_0196_TAIL_COMMIT
        and tail.get("tree") == TASK_0196_TAIL_TREE
        and tail.get("parent") == TASK_0196_TERMINAL_COMMIT
        and tail.get("changedPaths") == list(TASK_0196_TAIL_CHANGED_PATHS),
        f"{label}: tail binding drifted",
    )
    states = tail.get("nextActionStates")
    audit.require(
        isinstance(states, dict)
        and set(states) == {"terminalHandoff", "terminalState", "tailNextAction"}
        and states.get("terminalHandoff") == TASK_0196_TERMINAL_HANDOFF_NEXT_ACTION
        and states.get("terminalState") == TASK_0196_TERMINAL_STATE_NEXT_ACTION
        and states.get("tailNextAction") == TASK_0196_TERMINAL_STATE_NEXT_ACTION,
        f"{label}: nextAction state constants drifted",
    )
    tail_files = tail.get("files")
    audit.require(
        isinstance(tail_files, dict)
        and set(tail_files) == set(TASK_0196_TAIL_CHANGED_PATHS),
        f"{label}: tail file set drifted",
    )
    for path, identity in tail_files.items():
        expected = TASK_0196_TAIL_FILES[path]
        audit.require(
            isinstance(identity, dict)
            and set(identity)
            == {"terminalBlob", "terminalSha256", "tailBlob", "tailSha256"}
            and identity.get("terminalBlob") == expected["terminalBlob"]
            and identity.get("terminalSha256") == expected["terminalSha256"]
            and identity.get("tailBlob") == expected["tailBlob"]
            and identity.get("tailSha256") == expected["tailSha256"],
            f"{label}: tail file identity drifted: {path}",
        )
    ...
    audit.require(
        isinstance(draft, dict)
        and set(draft) == {"commit", "tree", "parent", "changedFiles"}
        and draft.get("commit") == TASK_0196_DRAFT_COMMIT
        and draft.get("tree") == TASK_0196_DRAFT_TREE
        and draft.get("parent") == TASK_0196_TAIL_COMMIT
        and isinstance(draft.get("changedFiles"), dict)
        and set(draft.get("changedFiles", {}))
        == {TASK_0196_CARD_PATH, TASK_0196_CONTEXT_PATH},
        f"{label}: DRAFT binding drifted",
    )
    for path, identity in (draft.get("changedFiles") or {}).items():
        expected = TASK_0196_DRAFT_FILES[path]
        audit.require(
            isinstance(identity, dict)
            and set(identity) == {"mode", "type", "blobOid", "sha256"}
            and identity.get("mode") == "100644"
    ...
    audit.require(
        ...
        and boundary.get("directParentCommit") == TASK_0196_DRAFT_COMMIT
        and boundary.get("directParentTree") == TASK_0196_DRAFT_TREE
        and boundary.get("singleParentRequired") is True
        and boundary.get("identityBinding")
        == "COMMIT_AND_TREE_DERIVED_FROM_EXACT_SINGLE_PARENT_CONTENT"
        and boundary.get("requiredMode") == "100644"
        and boundary.get("requiredType") == "blob"
        and boundary.get("policyContentBinding")
        == "CANONICAL_JSON_REDACT_TASK0196_BOUNDARY_DOCTOR_IDENTITY"
        and boundary.get("changedPaths")
        == sorted(TASK_0196_PRE_READY_MAINTENANCE_PATHS),
        f"{label}: boundary contract drifted",
    )
    audit.require(
        record.get("activation")
    ...
    audit.require(
        not any(
            key != "task0196PostTerminalTail" and value == record
            for key, value in policy.items()
        ),
        f"{label}: copied machine record is forbidden",
    )
    # Live tail edge facts: 751cb9d must be the direct single-parent child of
    # the terminal commit, changing exactly docs/handoffs/TASK-0195.json, with
    # the three-state nextAction verification below.
    graph = git_text(
        "rev-list",
        "--parents",
        "-n",
        "1",
        TASK_0196_TAIL_COMMIT,
    ).stdout.split()
    audit.require(
        graph == [TASK_0196_TAIL_COMMIT, TASK_0196_TERMINAL_COMMIT],
        f"{label}: tail must be a direct single-parent child of the terminal commit",
    )
    audit.require(
        changed_paths_between(
            TASK_0196_TERMINAL_COMMIT,
            TASK_0196_TAIL_COMMIT,
        )
        == list(TASK_0196_TAIL_CHANGED_PATHS),
        f"{label}: tail changed paths drifted",
    )
    tail_tree = git_text(
        "show",
    ...
    audit.require(
        tail_tree == TASK_0196_TAIL_TREE,
        f"{label}: tail tree drifted",
    )
    for path, identity in TASK_0196_TAIL_FILES.items():
        terminal_entry = git_tree_entry(TASK_0196_TERMINAL_COMMIT, path)
        tail_entry = git_tree_entry(TASK_0196_TAIL_COMMIT, path)
        audit.require(
            terminal_entry is not None
            and tail_entry is not None
            and terminal_entry[0] == "100644"
            and terminal_entry[1] == "blob"
            and terminal_entry[2] == identity["terminalBlob"]
            and tail_entry[0] == "100644"
            and tail_entry[1] == "blob"
            and tail_entry[2] == identity["tailBlob"],
            f"{label}: tail file mode/blob binding drifted: {path}",
        )
        audit.require(
            hashlib.sha256(
                git_object(TASK_0196_TERMINAL_COMMIT, path)
            ).hexdigest()
            == identity["terminalSha256"]
            and hashlib.sha256(
                git_object(TASK_0196_TAIL_COMMIT, path)
            ).hexdigest()
            == identity["tailSha256"],
            f"{label}: tail file content binding drifted: {path}",
        )
    # Three-state legacy healing verification (original mismatch -> unique
    # change -> final consistency); the terminal commit is never restated as
    # originally consistent.
    terminal_handoff_state = yaml_at_commit(
        TASK_0196_TERMINAL_COMMIT, PROJECT_STATE_PATH
    )
    tail_state = yaml_at_commit(TASK_0196_TAIL_COMMIT, PROJECT_STATE_PATH)
    try:
        ...
        audit.error(f"{label}: cannot parse terminal/tail handoff: {exc}")
        return None
    audit.require(
        isinstance(terminal_handoff, dict)
        and isinstance(terminal_handoff_state, dict)
        and terminal_handoff.get("nextAction")
        == TASK_0196_TERMINAL_HANDOFF_NEXT_ACTION
        and terminal_handoff_state.get("nextAction")
        == TASK_0196_TERMINAL_STATE_NEXT_ACTION
        and terminal_handoff.get("nextAction")
        != terminal_handoff_state.get("nextAction"),
        f"{label}: terminal original mismatch drifted (must stay byte-for-byte "
        "different, never restated as originally consistent)",
    )
    audit.require(
        isinstance(tail_handoff, dict)
        and isinstance(tail_state, dict)
        and tail_handoff.get("nextAction")
        == TASK_0196_TERMINAL_STATE_NEXT_ACTION
        and tail_state.get("nextAction")
        == TASK_0196_TERMINAL_STATE_NEXT_ACTION
        and tail_handoff.get("nextAction") == tail_state.get("nextAction"),
        f"{label}: tail final consistency drifted (must be byte-for-byte identical)",
    )
    return record


def task0196_post_terminal_tail_boundary_candidate(commit: str) -> bool:
    if not commit or not re.fullmatch(r"[0-9a-f]{40}", commit):
        return False
    parent_result = subprocess.run(
        ["git", "rev-list", "--parents", "-n", "1", commit],
    ...
    if parent_result.returncode != 0:
        return False
    parts = parent_result.stdout.split()
    return len(parts) == 2 and parts[0] == commit and parts[1] == TASK_0196_DRAFT_COMMIT


def validate_task0196_post_terminal_tail_boundary(
    audit: Audit,
    parent_commit: str,
) -> None:
    label = "TASK-0196 post-terminal tail acceptance"
    ...
    boundary_commit = parent_commit
    audit.require(
        task0196_post_terminal_tail_boundary_candidate(boundary_commit),
        f"{label}: boundary must be the direct single-parent child of the frozen DRAFT",
    )
    if not task0196_post_terminal_tail_boundary_candidate(boundary_commit):
        return
    tail_tree = git_text(
        "show",
        "-s",
    ...
    audit.require(
        draft_graph == [TASK_0196_DRAFT_COMMIT, TASK_0196_TAIL_COMMIT]
        and draft_tree == TASK_0196_DRAFT_TREE,
        f"{label}: DRAFT binding drifted",
    )
    ancestry = git_text(
        "rev-list",
        "--reverse",
        "--ancestry-path",
        f"{TASK_0196_TAIL_COMMIT}..{boundary_commit}",
    ).stdout.splitlines()
    audit.require(
        ancestry == [TASK_0196_DRAFT_COMMIT, boundary_commit],
        f"{label}: pre-READY ancestry contains an intervening commit",
    )
    draft_diff = subprocess.run(
        ["git", "diff", "--name-only", "--no-renames", "-z", TASK_0196_TAIL_COMMIT, TASK_0196_DRAFT_COMMIT],
        capture_output=True,
    )
    actual_draft_paths = {p.decode("utf-8") for p in draft_diff.stdout.split(b"\0") if p}
    audit.require(
        actual_draft_paths == {TASK_0196_CARD_PATH, TASK_0196_CONTEXT_PATH},
        f"{label}: DRAFT path set drifted",
    )
    boundary_diff = subprocess.run(
        ["git", "diff", "--name-only", "--no-renames", "-z", TASK_0196_DRAFT_COMMIT, boundary_commit],
        capture_output=True,
    )
    actual_paths = {p.decode("utf-8") for p in boundary_diff.stdout.split(b"\0") if p}
    audit.require(
        actual_paths == TASK_0196_PRE_READY_MAINTENANCE_PATHS,
        f"{label}: boundary paths must be exact",
    )
    audit.require(
        not (actual_paths - TASK_0196_PRE_READY_MAINTENANCE_PATHS),
        f"{label}: boundary contains extra path",
    )
    audit.require(
        not (TASK_0196_PRE_READY_MAINTENANCE_PATHS - actual_paths),
        f"{label}: boundary is missing a required path",
    )
    for path in sorted(TASK_0196_PRE_READY_MAINTENANCE_PATHS):
        entry = git_tree_entry(boundary_commit, path)
        audit.require(
            entry is not None
            and entry[:2]
    ...
    try:
        ...
        audit.error(f"{label}: cannot read boundary CI policy: {exc}")
        return
    record = validate_task0196_post_terminal_tail_record(audit, policy)
    if record is None:
        return
    boundary = record.get("boundary")
    boundary = boundary if isinstance(boundary, dict) else {}
    ...
    audit.require(
        set(exact_files)
        == set(TASK_0196_PRE_READY_MAINTENANCE_PATHS)
        - {CI_EXECUTION_POLICY_PATH, doctor_path},
        f"{label}: exact boundary file set drifted",
    )
    doctor_entry = git_tree_entry(boundary_commit, doctor_path)
    ...
    authorization_path = str(authorization.get("path", ""))
    audit.require(
        authorization_path == TASK_0196_MAINTENANCE_AUTHORIZATION_PATH
        and hashlib.sha256(
            git_object(boundary_commit, authorization_path)
        ).hexdigest()
        == str(authorization.get("sha256", "")),
...
def validate_task0196_card_maintenance_contract(audit: Audit) -> None:
    label = "TASK-0196 post-terminal tail card"
    try:
        task = task_metadata_from_text(
            read_repository_text(ROOT / TASK_0196_CARD_PATH),
            TASK_0196_CARD_PATH,
        )
    except (HarnessError, OSError, UnicodeError, yaml.YAMLError) as exc:
        audit.error(f"{label}: cannot read exact task card: {exc}")
        return
    audit.require(
        task.get("taskId") == TASK_0196_TASK_ID
        and task.get("baseCommit") == TASK_0196_TAIL_COMMIT
        and task.get("contextLock") == TASK_0196_CONTEXT_PATH
        and task.get("requiredSkillVersions")
        == {
            "task-delivery-flow": "1.3.7",
            "task-intake": "1.2.7",
    ...
    tail_acceptance = task.get("postTerminalTailAcceptance")
    tail_acceptance = tail_acceptance if isinstance(tail_acceptance, dict) else {}
    audit.require(
        tail_acceptance.get("recordId") == TASK_0196_POST_TERMINAL_TAIL_RECORD_ID
        and tail_acceptance.get("uniqueHistoricalException") is True
        and tail_acceptance.get("legacyHealingException") is True
        and tail_acceptance.get("terminal")
        == {
            "commit": TASK_0196_TERMINAL_COMMIT,
            "tree": TASK_0196_TERMINAL_TREE,
            "taskId": TASK_0196_TERMINAL_TASK_ID,
        ...
        and isinstance(tail_acceptance.get("tail"), dict)
        and tail_acceptance["tail"].get("commit") == TASK_0196_TAIL_COMMIT
        and tail_acceptance["tail"].get("tree") == TASK_0196_TAIL_TREE
        and tail_acceptance["tail"].get("parent") == TASK_0196_TERMINAL_COMMIT
        and tail_acceptance["tail"].get("changedPaths")
        == list(TASK_0196_TAIL_CHANGED_PATHS)
        and tail_acceptance.get("draftAnchorBaseCommit") == TASK_0196_TAIL_COMMIT,
        f"{label}: tail acceptance contract drifted",
    )
    maintenance = task.get("preReadyMaintenancePlan")
    maintenance = maintenance if isinstance(maintenance, dict) else {}
    audit.require(
        maintenance.get("recordId") == TASK_0196_PRE_READY_RECORD_ID
        and maintenance.get("recordPath") == TASK_0196_MAINTENANCE_AUTHORIZATION_PATH
        and maintenance.get("kind")
        == "OWNER_AUTHORIZED_EXACT_ONE_TIME_PRE_READY_MAINTENANCE"
        and maintenance.get("directSingleParentFromDraftRequired") is True
        and maintenance.get("pathSetFrozenAtDraft") is True
        ...
        and maintenance.get("reusable") is False
        and maintenance.get("consumedRecordMustBecomeInert") is True
        and maintenance.get("provenanceRetainedForHistoryVerification") is True
        and isinstance(maintenance.get("exactPaths"), list)
        and set(maintenance.get("exactPaths", []))
        == TASK_0196_PRE_READY_MAINTENANCE_PATHS
        and len(maintenance.get("exactPaths", []))
        == len(TASK_0196_PRE_READY_MAINTENANCE_PATHS),
        f"{label}: frozen maintenance contract drifted",
    )
    approvals = task.get("humanApprovals")
    approvals = approvals if isinstance(approvals, list) else []
    ...
    tail_approval = next(
        (
            ...
            for item in approvals
            if isinstance(item, dict)
            and item.get("scope") == "post-terminal-tail-acceptance"
        ),
        None,
    )
    audit.require(
        isinstance(harness_approval, dict)
        and harness_approval.get("approvedBy") == "repository-owner"
        and harness_approval.get("approvedAt") == "2026-08-14"
        and isinstance(harness_approval.get("evidence"), str)
        and TASK_0196_PRE_READY_RECORD_ID
        in harness_approval["evidence"]
        and "pre-READY maintenance" in harness_approval["evidence"],
        f"{label}: exact Owner maintenance authorization drifted",
    )
    audit.require(
        isinstance(tail_approval, dict)
        and tail_approval.get("approvedBy") == "repository-owner"
        and tail_approval.get("approvedAt") == "2026-08-14"
        and isinstance(tail_approval.get("evidence"), str)
        and TASK_0196_POST_TERMINAL_TAIL_RECORD_ID
        in tail_approval["evidence"]
        and "唯一历史例外" in tail_approval["evidence"],
        f"{label}: exact Owner tail acceptance authorization drifted",
    )
    recovery = task.get("preReadyMaintenanceRecoveryPlan")
    recovery = recovery if isinstance(recovery, dict) else {}
    audit.require(
        recovery.get("recordId") == TASK_0196_RECOVERY_RECORD_ID
        and recovery.get("recordPath") == TASK_0196_RECOVERY_AUTHORIZATION_PATH
        and recovery.get("kind")
        == "OWNER_AUTHORIZED_EXACT_ONE_TIME_PRE_READY_RECOVERY_MAINTENANCE"
        and recovery.get("directParentCommitRequired") == TASK_0196_FAILED_ATTEMPT_COMMIT
        and recovery.get("failedAttemptCommit") == TASK_0196_FAILED_ATTEMPT_COMMIT
        and recovery.get("failedAttemptTree") == TASK_0196_FAILED_ATTEMPT_TREE
        and recovery.get("originalDraftCommit") == TASK_0196_ORIGINAL_DRAFT_COMMIT
        and recovery.get("oneTimeOnly") is True
        and recovery.get("reusable") is False
        and recovery.get("consumedRecordMustBecomeInert") is True
        and recovery.get("provenanceRetainedForHistoryVerification") is True
        and recovery.get("firstRecordInerted") is True
        and recovery.get("secondRecordFixesKnownFailureOnly") is True
        and recovery.get("generalizationForbidden") is True
        and isinstance(recovery.get("exactPaths"), list)
        and set(recovery.get("exactPaths", [])) == TASK_0196_RECOVERY_PATHS
        and len(recovery.get("exactPaths", [])) == len(TASK_0196_RECOVERY_PATHS),
        f"{label}: frozen recovery maintenance contract drifted",
    )
    maintenance = task.get("preReadyMaintenancePlan")
    maintenance = maintenance if isinstance(maintenance, dict) else {}
    audit.require(
        maintenance.get("attemptCommit") == TASK_0196_FAILED_ATTEMPT_COMMIT
        and maintenance.get("attemptTree") == TASK_0196_FAILED_ATTEMPT_TREE
        and maintenance.get("attemptOutcome") == "CONSUMED_IMPLEMENTATION_FAILED"
        and maintenance.get("recordId") == TASK_0196_PRE_READY_RECORD_ID,
        f"{label}: first maintenance record must stay auditable but inert",
    )
    audit.require(
        isinstance(harness_approval, dict)
        and TASK_0196_RECOVERY_RECORD_ID in harness_approval["evidence"]
...
def validate_task0196_post_terminal_tail_recovery_record(
    ...
    """TASK-0196 append-only recovery edge record (RECOVERY-02).

    The second one-time recovery edge must be the direct single-parent child
    of the failed attempt 8114da2, changing exactly the 7 frozen recovery
    paths. It binds TASK-0196, the original DRAFT ea129d1, the failed attempt
    8114da2 with its commit/tree, the direct parent, the exact path set and
    per-path mode/blob/content hashes. The first maintenance record stays
    auditable but inert; this second record fixes only the known failure and
    never becomes a general "maintenance after maintenance" capability.
    """
    record = policy.get("task0196PostTerminalTailRecovery")
    label = "TASK-0196 pre-READY recovery edge"
    audit.require(
        isinstance(record, dict),
        f"{label}: machine record is missing or not an object",
    )
    ...
    audit.require(
        record.get("schemaVersion") == 1
        and record.get("recordId") == TASK_0196_RECOVERY_RECORD_ID
        and record.get("decisionId")
        == "TASK-0196-PRE-READY-RECOVERY-ACCEPTANCE-20260814"
        and record.get("kind")
        == "OWNER_AUTHORIZED_EXACT_ONE_TIME_PRE_READY_RECOVERY_MAINTENANCE"
        and record.get("targetTask") == TASK_0196_TASK_ID
        and record.get("sourceThreadId") == "zcode-main-20260814",
    ...
    audit.require(
        isinstance(authorization, dict)
        and set(authorization) == {"path", "sha256"}
        and authorization.get("path") == TASK_0196_RECOVERY_AUTHORIZATION_PATH
        and bool(
            re.fullmatch(
                r"[0-9a-f]{64}",
                str(authorization.get("sha256", "")),
    ...
    audit.require(
        ...
        and boundary.get("directParentCommit") == TASK_0196_FAILED_ATTEMPT_COMMIT
        and boundary.get("directParentTree") == TASK_0196_FAILED_ATTEMPT_TREE
        and boundary.get("singleParentRequired") is True
        and boundary.get("identityBinding")
        == "COMMIT_AND_TREE_DERIVED_FROM_EXACT_SINGLE_PARENT_CONTENT"
        and boundary.get("requiredMode") == "100644"
        and boundary.get("requiredType") == "blob"
        and boundary.get("policyContentBinding")
        == "CANONICAL_JSON_REDACT_TASK0196_RECOVERY_DOCTOR_IDENTITY"
        and boundary.get("changedPaths") == sorted(TASK_0196_RECOVERY_PATHS),
        f"{label}: recovery boundary contract drifted",
    )
    audit.require(
        record.get("activation")
        == {
    ...
    audit.require(
        not any(
            key != "task0196PostTerminalTailRecovery" and value == record
            for key, value in policy.items()
        ),
        f"{label}: copied machine record is forbidden",
    )
    # Live edge facts are validated by validate_task0196_recovery_boundary
    # against the actual READY-parent commit (the recovery-edge SHA cannot be
    # known before the boundary commit exists): direct single-parent child of
    # the failed attempt, exact 7-path diff, per-path mode/blob/content.
    return record


def task0196_recovery_boundary_candidate(commit: str) -> bool:
    if not commit or not re.fullmatch(r"[0-9a-f]{40}", commit):
        return False
    parent_result = subprocess.run(
        ["git", "rev-list", "--parents", "-n", "1", commit],
    ...
    return (
        len(parts) == 2
        and parts[0] == commit
        and parts[1] == TASK_0196_FAILED_ATTEMPT_COMMIT
    )


def validate_task0196_recovery_boundary(
    audit: Audit,
    parent_commit: str,
) -> None:
    label = "TASK-0196 pre-READY recovery edge"
    ...
    boundary_commit = parent_commit
    audit.require(
        task0196_recovery_boundary_candidate(boundary_commit),
        f"{label}: boundary must be the direct single-parent child of the failed attempt",
    )
    if not task0196_recovery_boundary_candidate(boundary_commit):
        return
    ...
    audit.require(
        ...
        f"{label}: recovery ancestry contains an intervening commit",
    )
    boundary_diff = subprocess.run(
        ["git", "diff", "--name-only", "--no-renames", "-z", TASK_0196_FAILED_ATTEMPT_COMMIT, boundary_commit],
        capture_output=True,
    )
    actual_paths = {p.decode("utf-8") for p in boundary_diff.stdout.split(b"\0") if p}
    audit.require(
        actual_paths == TASK_0196_RECOVERY_PATHS,
        f"{label}: recovery boundary paths must be exact",
    )
    audit.require(
        not (actual_paths - TASK_0196_RECOVERY_PATHS),
        f"{label}: recovery boundary contains extra path",
    )
    audit.require(
        not (TASK_0196_RECOVERY_PATHS - actual_paths),
        f"{label}: recovery boundary is missing a required path",
    )
    for path in sorted(TASK_0196_RECOVERY_PATHS):
        entry = git_tree_entry(boundary_commit, path)
        audit.require(
            entry is not None
            and entry[:2] == ("100644", "blob"),
            f"{label}: recovery boundary mode/type drifted: {path}",
        )
    try:
        policy = yaml_at_commit(boundary_commit, CI_EXECUTION_POLICY_PATH)
    except HarnessError as exc:
        audit.error(f"{label}: cannot read boundary CI policy: {exc}")
        return
    record = validate_task0196_post_terminal_tail_recovery_record(audit, policy)
    if record is None:
        return
    boundary = record.get("boundary")
    boundary = boundary if isinstance(boundary, dict) else {}
    ...
    audit.require(
        set(exact_files)
        == set(TASK_0196_RECOVERY_PATHS)
        - {CI_EXECUTION_POLICY_PATH, doctor_path, TASK_0196_CARD_PATH},
        f"{label}: exact boundary file set drifted",
    )
    doctor_entry = git_tree_entry(boundary_commit, doctor_path)
    audit.require(
...
def legacy_terminal_c1_c2_reviewers_omission_allowed(
    task: dict[str, Any],
) -> bool:
    """Strictly limited legacy compatibility for the reviewers field.

    Only a terminal-state (ACCEPTED/REJECTED/SUPERSEDED) task whose riskClass
    is C1 or C2 and whose independentReview is exactly "not-required" may omit
    the reviewers field. This covers the historical compressed-delivery cards
    (TASK-0185/0186/0187) created under the 2026-08-13 Owner "skip long
    checks" policy. Every other shape (active state, C3/C4, required review,
    or an explicit non-not-required value) fails closed.
    """
    if not isinstance(task, dict):
        return False
    if task.get("state") not in ("ACCEPTED", "REJECTED", "SUPERSEDED"):
        return False
    if task.get("riskClass") not in ("C1", "C2"):
        return False
    return str(task.get("independentReview", "")).strip().lower() == "not-required"
...
def validate_tasks(
    ...
    for task_id, task in tasks.items():
        ...
        if (
            "reviewers" in missing
            and legacy_terminal_c1_c2_reviewers_omission_allowed(task)
        ):
            # Strictly limited legacy compatibility: only terminal-state C1/C2
            # tasks with independentReview: not-required may omit the
            # reviewers field (historical compressed-delivery cards under the
            # 2026-08-13 "skip long checks" Owner policy). Every other
            # omission still fails closed.
            missing.remove("reviewers")
...
def validate_task_base_handoff_anchors(
    ...
    for task_id, task in tasks.items():
        ...
        try:
            ...
            task0189_tail_anchor = (
                task_id == TASK_0189_TASK_ID
                and base_commit == TASK_0189_TAIL_COMMIT
            )
            if task0098_tail_anchor:
            ...
            elif task0189_tail_anchor:
                # TASK-0189 one-time post-terminal tail acceptance: the tail
                # edge 7f9f9e3 -> c626005 is not a canonical idle planning
                # checkpoint; the machine record validates and accepts it as
                # the DRAFT anchor instead (skip the checkpoint derivation so
                # it does not emit non-applicable resolution-edge errors).
                policy = load_yaml(ROOT / CI_EXECUTION_POLICY_PATH)
                ...
                task_id == TASK_0196_TASK_ID
                and base_commit == TASK_0196_TAIL_COMMIT
            ):
                # TASK-0196 one-time post-terminal tail acceptance: the
                # unregistered tail edge fe0253f -> 751cb9d is accepted only
                # through its exact machine record (unique historical
                # exception); the record validates the three-state nextAction
                # verification and the live edge facts, then accepts the tail
                # as the DRAFT anchor.
                policy = load_yaml(ROOT / CI_EXECUTION_POLICY_PATH)
                record = validate_task0196_post_terminal_tail_record(audit, policy)
                if record is not None:
...
def validate_task_delivery_policy(audit: Audit) -> None:
    ...
    validate_task0189_card_maintenance_contract(audit)
...
def validate_evidence_and_handoffs(
    ...
    for task_id, task in tasks.items():
        ...
        if task.get("state") in ("ACCEPTED", "REJECTED"):
            ...
            # "never re-judge immutable historical artifacts against the
            # current schema" rule. Historical tasks keep their lightweight
            # path here; post-terminal governance is enforced by the
            # dedicated validate_post_terminal_governance_edges validator
            # (unregistered parent edges fail closed, registered edges must
            # exactly match a one-time record, and the original card
            # writeAllowlist never authorizes post-terminal changes).
            continue
...
def validate_post_terminal_governance_edges(
    audit: Audit,
    state: dict[str, Any],
    tasks: dict[str, dict[str, Any]],
    lifecycle: dict[str, Any],
    ...
    """Dedicated post-terminal edge validator (Owner 2026-08-14 plan D).

    Runs in the idle state (no active task, no pending DRAFT, last terminal
    task present). For the last terminal task it scans every parent edge after
    the canonical terminal commit that touches terminal governance artifacts
    (task card, Context Lock, Evidence, Handoff, project-state, ledger):
    - unregistered parent edges fail closed by default;
    - registered edges must exactly match a one-time record;
    - the original card writeAllowlist never authorizes post-terminal changes;
    - registered records (TASK-0196 fe0253f -> 751cb9d, the unique historical
      exception) are integrated into frozen-artifact, post-terminal history,
      and nextAction final-consistency checks;
    - baseCommit may only sit at the end of a complete, continuous, registered
      tail chain (this card: exactly fe0253f -> 751cb9d, never HEAD in general).
    Tasks that existed before enforcement activation without any post-terminal
    edge (e.g. TASK-0141 nextAction mismatch) are not retroactively blocked
    here; they are recorded as separate legacy governance findings and no
    general quarantine/ignore mechanism is introduced.
    """
    if str(state.get("activeTask", "") or ""):
        return
    if allow_pending_draft:
        return
    last_terminal = str(state.get("lastTerminalTask", ""))
    last = tasks.get(last_terminal)
    if last is None or last.get("state") not in {"ACCEPTED", "REJECTED"}:
        return
    try:
    ...
    if head_commit == terminal_commit:
        return
    policy = load_yaml(ROOT / CI_EXECUTION_POLICY_PATH)
    task0196_tail_covered = (
        last_terminal == TASK_0196_TERMINAL_TASK_ID
        and head_commit == TASK_0196_TAIL_COMMIT
        and validate_task0196_post_terminal_tail_record(audit, policy) is not None
    )
    if task0196_tail_covered:
        # The registered tail 751cb9d is the unique historical exception.
        # Frozen-artifact baseline becomes the tail version and nextAction
        # final consistency is verified at the tail commit (the three-state
        # legacy healing was validated by the record itself).
        for path in TASK_0196_TAIL_CHANGED_PATHS:
            tail_entry = git_tree_entry(TASK_0196_TAIL_COMMIT, path)
            audit.require(
                tail_entry is not None and tail_entry[:2] == ("100644", "blob"),
                f"{last_terminal}: {path} must be a regular 100644 blob at the registered tail",
            )
            if tail_entry is not None:
                audit.require(
                    git_worktree_blob_oid(path) == tail_entry[2],
                    f"{last_terminal}: frozen worktree content changed after registered tail: {path}",
                )
                audit.require(
                    git_index_entry(path) == (tail_entry[0], tail_entry[2]),
                    f"{last_terminal}: frozen index entry changed after registered tail: {path}",
                )
        tail_head_diff = changed_paths_between(TASK_0196_TAIL_COMMIT, head_commit)
        audit.require(
            not tail_head_diff,
            f"{last_terminal}: repository changed after the registered tail "
            f"without a new task: {sorted(tail_head_diff)}",
        )
        tail_handoff_state = yaml_at_commit(TASK_0196_TAIL_COMMIT, PROJECT_STATE_PATH)
        try:
            tail_handoff = json.loads(
                git_object(
                    TASK_0196_TAIL_COMMIT,
            ...
            audit.error(f"{last_terminal}: cannot parse registered-tail handoff: {exc}")
            return
        audit.require(
            isinstance(tail_handoff, dict)
            and isinstance(tail_handoff_state, dict)
            and tail_handoff.get("nextAction")
            == tail_handoff_state.get("nextAction"),
            f"{last_terminal}: Handoff nextAction disagrees with project-state "
            "at the registered tail",
        )
        return
    # Unregistered post-terminal edges: every edge touching the terminal
    # governance artifacts fails closed; the original card writeAllowlist is
    # never a post-terminal authorization.
    governance_prefixes = (
        f"docs/tasks/{last_terminal}",
        f"docs/tasks/context/{last_terminal}",
        f"docs/evidence/{last_terminal}/",
        f"docs/handoffs/{last_terminal}.json",
        ".harness/project-state.yaml",
        ".harness/task-ledger.yaml",
    )
    history = git_text(
    ...
    parent = terminal_commit
    for commit in history:
        commit = commit.strip()
        changed = changed_paths_between(parent, commit)
        touched = [
            path
            for path in changed
        ...
        if touched:
            audit.error(
                f"{last_terminal}: unregistered post-terminal edge "
                f"{parent[:8]}..{commit[:8]} touches terminal governance "
                f"artifacts: {sorted(touched)}"
            )
        parent = commit
    validate_idle_terminal_history(audit, last_terminal, terminal_commit)
...
def validate_draft_checkpoint(
    ...
    task0189_tail_anchor = (
        task_id == TASK_0189_TASK_ID
        and base_commit_str == TASK_0189_TAIL_COMMIT
    )
    if task0098_tail_anchor:
        ...
        # TASK-0189 one-time post-terminal tail acceptance: skip the idle
        # planning checkpoint derivation (the tail is not a canonical
        # resolution edge); the machine record accepts the tail as the
        # effective DRAFT boundary.
        policy = load_yaml(ROOT / CI_EXECUTION_POLICY_PATH)
        ...
        task_id == TASK_0196_TASK_ID
        and base_commit_str == TASK_0196_TAIL_COMMIT
    ):
        # TASK-0196 one-time post-terminal tail acceptance: the unregistered
        # tail edge fe0253f -> 751cb9d is accepted only through its exact
        # machine record (unique historical exception); the record validates
        # the three-state nextAction verification and the live edge facts,
        # then accepts the tail as the effective DRAFT boundary.
        policy = load_yaml(ROOT / CI_EXECUTION_POLICY_PATH)
        record = validate_task0196_post_terminal_tail_record(audit, policy)
        if record is not None:
            effective_terminal = base_commit_str
        ...
        with doctor_git_snapshot() as snapshot:
            try:
                ...
                with timed_phase("post-terminal governance edges"):
                    validate_post_terminal_governance_edges(
                        audit,
                        state,
                        tasks,
                        lifecycle,
