...
--   is initialized idempotently by the migrator startup phase via bound database connection
...
--
-- Append-only: V1-V26 are untouched (migration history checksum safe). No RLS policy,
