# TASK-0140：P2-23 供应链可复现（GitHub Actions 固定完整 commit SHA + Harness Python 依赖精确版本与 hash lock）
...
authorizationCommit: 89cf7ac3641a88d5a1373dd28c25e34cac4b7a1e
contextFingerprint: 7ba2995e38ef411f1b71e672e833565fe16c311d63cec57f4b7d728d99e5d6aa
contextLock: docs/tasks/context/TASK-0140.context-lock.yaml
...
complexityAssessment:
  ...
  riskClass: C4
  surfaceId: TASK_0140_P2_23_SUPPLY_CHAIN_REPRODUCIBILITY
  ...
  indivisibleReason: >-
    ...
    路径被两张卡重复触碰且验收互相依赖；Owner 已通过本会话授权请求批准该合并范围与写路径。
...
readAllowlist:
  ...
  - owner-authorization/TASK-0140/019fdf92-9c99-7400-a2ea-d490ef3d7e15
...
humanApprovals:
  - scope: task-assignment
    ...
    evidence: >-
      Owner 于 2026-08-10 长线会话授权请求中批准创建 TASK-0140 C4 卡（P2-23 供应链可复现：
      GitHub Actions 固定完整 commit SHA + Harness Python 依赖精确版本与 hash lock），
      合并 P2-23 与 P2-24 为一张卡，自 DRAFT 起纳入 .github/workflows/ci.yml、
      requirements-harness.txt 与 scripts/harness/tests/test_harness.py 写路径；
      actions 固定 SHA 采用 2026-08-10 从各 actions 仓库 tag 解析的 commit（checkout@v6=
      d23441a48e516b6c34aea4fa41551a30e30af803、setup-python@v6=ece7cb06caefa5fff74198d8649806c4678c61a1、
      setup-java@v4=cf277c60eb25467037889841efdb72551f06f6c3、setup-node@v6=
      249970729cb0ef3589644e2896645e5dc5ba9c38、upload-artifact@v4=ea165f8d65b6e75b540449e92b4886f43607fa02、
      pnpm/action-setup@v6=0977fd99725f1db4007ccb2928dbb4e90d06cc86），依赖锁定当前受控
      环境已验证版本 PyYAML==6.0.3、tzdata==2026.3；禁止历史改写和伪造 PASS。
...
> 依赖精确版本与 hash lock 的可复现供应链」一张 C4 卡，Owner 已批准合并范围与写路径。
...
- Base `75644e7d25c8c39da228c26bda10316ce2758d5f` 是 TASK-0139 单父 ACCEPTED terminal，
