...
> 状态：implementation baseline（G0–G11 已合入，G13 Go-only 切流与旧技术链清理
> 已完成，事实记录见 ADR-0008；G12 资源/容量验收与 Go-only dogfood 尚待 Owner
> 冻结门槛。G1/G11 只保留为历史决策背景，不再提供旧运行时复跑入口。）
> 日期：2026-08-30
